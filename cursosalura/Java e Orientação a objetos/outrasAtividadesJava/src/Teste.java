...
public class Teste {
    ...
    public static void adicionarContato(Scanner scan,Agenda agenda){
        ...
        try {
            ...
            String nome = leInformacaoString(scan, "Entre com nome do contato:");
            String telefone = leInformacaoString(scan, "Entre com o telefone:");
            String email = leInformacaoString(scan, "Entre com o email:");
    ...
    public static void consultarContato(Scanner scan, Agenda agenda){
        ...
        } catch (ContatoNaoExisteExpection e) {
            System.out.println(e.getMessage());
        }
    }
